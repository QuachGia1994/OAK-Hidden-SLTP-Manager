...
- H=2 on **Tuesday does not reverse XAU** (normal pattern). Thursday uses T2 history. Special-calendar Friday reverses.
- H=4 D-direction still calculates but is hidden from display.
