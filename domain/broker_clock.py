...
class BrokerClock:
    ...
    def _stable_period(value: date) -> tuple[str, int] | None:
        ...
        # Wall-encoded MT5 timestamps do not reveal the historical UTC offset.
        # Keep a buffer around both common spring/fall transition schedules rather
        # than assuming this broker follows one specific DST calendar.
