...
""",
        ...
        # --- Runtime UI (dashboard / multi-monitor / diagnostics) ---
        "ui_card_account": "📊 Tài khoản",
        "ui_card_signal": "📈 Tín hiệu",
        "ui_card_engine": "⚙️ Engine",
        "ui_status": "Trạng thái",
        "ui_status_dash": "Trạng thái: —",
        "ui_current": "Hiện tại",
        "ui_current_dash": "Hiện tại: —",
        "ui_next": "Tiếp theo",
        "ui_countdown": "Đếm ngược",
        "ui_ghost": "Ghost",
        "ui_ghost_active": "Bật",
        "ui_ghost_off": "Tắt",
        "ui_session_on": "Phiên: BẬT",
        "ui_selected": "Đang chọn",
        "ui_running_monitor": "Monitor chạy",
        "ui_running": "Đang chạy",
        "ui_account_source": "Nguồn tài khoản",
        "ui_waiting_worker": "Chờ worker...",
        "ui_connected": "Đã kết nối",
        "ui_disconnected": "Mất kết nối",
        "ui_degraded": "Suy giảm",
        "ui_stale": "cũ",
        "ui_ago": "trước",
        "ui_configured": "Đã cấu hình",
        "ui_not_configured": "Chưa cấu hình",
        "ui_api_ok": "API OK",
        "ui_running_monitors": "Monitor đang chạy",
        "ui_no_monitors": "Không có monitor",
        "ui_stop": "Dừng",
        "ui_stop_monitor_title": "Dừng monitor đang chạy",
        "ui_profile": "Profile",
        "ui_pid": "PID",
        "ui_account": "Tài khoản",
        "ui_other_monitors": "Các monitor khác vẫn chạy.",
        "ui_other_monitors_list": "Các monitor khác vẫn chạy: {names}.",
        "ui_cancel": "Huỷ",
        "ui_stop_named": "Dừng {name}",
        "ui_start_named": "BẮT ĐẦU {name}",
        "ui_stop_named_btn": "DỪNG {name}",
        "ui_profiles_running": "ĐANG CHẠY",
        "ui_profiles_editing": "ĐANG SỬA",
        "ui_diag_title": "Chẩn đoán & Nhật ký",
        "ui_diag_scope": "Phạm vi:",
        "ui_diag_scope_session": "Phiên hiện tại",
        "ui_diag_scope_15m": "15 phút gần nhất",
        "ui_diag_scope_all": "Toàn bộ lịch sử",
        "ui_diag_level": "Mức:",
        "ui_diag_auto_refresh": "Tự làm mới",
        "ui_diag_follow": "Theo dòng mới",
        "ui_diag_refresh": "Làm mới",
        "ui_diag_clear": "Xoá màn hình",
        "ui_diag_archive": "Lưu trữ & Log mới",
        "ui_diag_copy": "Sao chép",
        "ui_diag_open_folder": "Mở thư mục log",
        "ui_diag_export": "Xuất Debug Bundle",
        "ui_diag_ready": "Sẵn sàng",
        "ui_about_docs": "Tài liệu",
        "ui_about_updates": "Kiểm tra cập nhật",
        "ui_about_subtitle": "Bảng điều khiển giao dịch · MT4 / MT5",
        "ui_copy_safety": "Hàng rào an toàn",
        "ui_copy_max_daily": "Tối đa lệnh/ngày",
        "ui_copy_max_lot": "Lot tối đa mỗi lệnh",
        "ui_copy_max_exposure": "Exposure tối đa/symbol (lot)",
        "ui_copy_kill": "KILL SWITCH",
        "ui_copy_kill_hint": "Chặn mọi lệnh copy mới khi BẬT",
        "ui_copy_stop_new": "Dừng lệnh copy mới",
        "ui_copy_stale": "Ngưỡng tín hiệu cũ (giây)",
        "ui_copy_test_title": "Kiểm tra an toàn",
        "ui_copy_test_symbol": "Symbol thử",
        "ui_copy_test_lot": "Lot thử",
        "ui_copy_test_type": "Loại thử",
        "ui_copy_test_btn": "Chạy kiểm tra an toàn",
        "ui_profile_none": "Profile: Không",
        "ui_profile_named": "Profile: {name}",
        "ui_stable": "Ổn định",
        "ui_btn_ghost_short": "👻 Ghost",
        "ui_n_of_m_connected": "{n}/{m} đã kết nối",
    },
    "EN": {
...
""",
        ...
        # --- Runtime UI (dashboard / multi-monitor / diagnostics) ---
        "ui_card_account": "📊 Account",
        "ui_card_signal": "📈 Signal",
        "ui_card_engine": "⚙️ Engine",
        "ui_status": "Status",
        "ui_status_dash": "Status: —",
        "ui_current": "Current",
        "ui_current_dash": "Current: —",
        "ui_next": "Next",
        "ui_countdown": "Countdown",
        "ui_ghost": "Ghost",
        "ui_ghost_active": "Active",
        "ui_ghost_off": "Off",
        "ui_session_on": "Session: ON",
        "ui_selected": "Selected",
        "ui_running_monitor": "Running Monitor",
        "ui_running": "Running",
        "ui_account_source": "Account Source",
        "ui_waiting_worker": "Waiting for worker...",
        ...
        "ui_not_configured": "Not configured",
        "ui_api_ok": "API OK",
        "ui_running_monitors": "Running Monitors",
        "ui_no_monitors": "No monitors running",
        "ui_stop": "Stop",
        "ui_stop_monitor_title": "Stop running monitor",
        "ui_profile": "Profile",
        "ui_pid": "PID",
        "ui_account": "Account",
        "ui_other_monitors": "Other monitors will remain active.",
        "ui_other_monitors_list": "Other monitors will remain active: {names}.",
        "ui_cancel": "Cancel",
        "ui_stop_named": "Stop {name}",
        "ui_start_named": "START {name}",
        "ui_stop_named_btn": "STOP {name}",
        "ui_profiles_running": "RUNNING",
        "ui_profiles_editing": "EDITING",
        "ui_diag_title": "Diagnostics & Logs",
        "ui_diag_scope": "Scope:",
        "ui_diag_scope_session": "Current Session",
        "ui_diag_scope_15m": "Last 15 Minutes",
        "ui_diag_scope_all": "All History",
        "ui_diag_level": "Level:",
        "ui_diag_auto_refresh": "Auto Refresh",
        "ui_diag_follow": "Follow Latest",
        "ui_diag_refresh": "Refresh",
        "ui_diag_clear": "Clear Display",
        "ui_diag_archive": "Archive & Start New Log",
        "ui_diag_copy": "Copy Selected",
        "ui_diag_open_folder": "Open Log Folder",
        "ui_diag_export": "Export Debug Bundle",
        "ui_diag_ready": "Ready",
        "ui_about_docs": "Documentation",
        "ui_about_updates": "Check Updates",
        "ui_about_subtitle": "Trading Operations Console · MT4 / MT5",
        "ui_copy_safety": "Safety Guardrails",
        "ui_copy_max_daily": "Max Daily Trades",
        "ui_copy_max_lot": "Max Lot Per Trade",
        "ui_copy_max_exposure": "Max Exposure/Symbol (lots)",
        "ui_copy_kill": "KILL SWITCH",
        "ui_copy_kill_hint": "Blocks all new copy entries when ON",
        "ui_copy_stop_new": "Stop All New Trades",
        "ui_copy_stale": "Stale Signal Threshold (sec)",
        "ui_copy_test_title": "Test Safety Rules",
        "ui_copy_test_symbol": "Test Symbol",
        "ui_copy_test_lot": "Test Lot",
        "ui_copy_test_type": "Test Type",
        "ui_copy_test_btn": "Test Safety Rules",
        "ui_profile_none": "Profile: None",
        "ui_profile_named": "Profile: {name}",
        "ui_stable": "Stable",
        "ui_btn_ghost_short": "👻 Ghost",
        "ui_n_of_m_connected": "{n}/{m} Connected",
