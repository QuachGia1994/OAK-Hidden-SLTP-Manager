...
const UI_COPY = {
  vi: {
    ...
    patternHint: 'ngày giao dịch trước · lookback 4 nến H4 mới → cũ · base = cây #4: Sw đảo chiều base, Bt giữ chiều base.', reverseHint: 'Reverse cuối: H3 T2/T5 + T6 theo chu kỳ tháng · H7 T2/T3/T6 · H9 T5/T6 · H12 trừ T4 · H14 tất cả.', evidenceTitle: 'Bằng chứng 4 nến H4', evidenceHint: 'Chart trái → phải = cũ → mới · OHLC lấy trực tiếp từ 4 nến lookback.', refresh: 'Làm mới MT5', refreshing: 'Đang tính…', patternEmpty: 'Chưa có dữ liệu Pattern5. Nhấn Làm mới MT5.', patternLoading: 'Đang đọc H4/D1 broker-time, phân nhóm Sw/Bt và tính Reverse Signal…'
  },
  en: {
