...
export type PatternCell = { group: 'Sw' | 'Bt'; baseSignal: 'BUY' | 'SELL'; signal: 'BUY' | 'SELL'; reversed: boolean; label: string; pattern: string; evidence: PatternCandle[] } | '';
export type Pattern5Reference = { date: string; display: string; group: 'Sw' | 'Bt'; pattern: string };
