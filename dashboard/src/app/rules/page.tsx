          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-zinc-200 dark:border-zinc-800">
                ...
                <th className="text-left text-xs uppercase tracking-wider text-zinc-500 dark:text-zinc-400 px-4 py-2">Skip ngày</th>
              </tr>
            </thead>
            <tbody>
              {SCHEDULE.map((s) => {
                ...
                return (
                  <tr key={s.hour} className={`border-b border-zinc-100 dark:border-zinc-800/50 last:border-0 ${isSkippedToday ? "opacity-40" : ""}`}>
                    ...
                    <td className="px-4 py-2.5 text-sm text-zinc-400 dark:text-zinc-500">
