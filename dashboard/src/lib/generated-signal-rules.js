...
export const RULES_BY_LOCALE = {
  "VN": [
    ...
    "Layer 4 (Final Reverse) chạy sau core Signal của cả năm pair và chỉ áp dụng đúng một lần.",
  ...
  "EN": [
    ...
    "Layer 4 (Final Reverse) runs after the five-pair core Signal and is applied exactly once.",
