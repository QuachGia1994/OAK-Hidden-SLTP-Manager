...
export const RULES_BY_LOCALE = {
  "VN": [
    ...
    "Layer 4 (Final Reverse) chạy sau core Signal và chỉ đảo XAUUSD đúng một lần; GBP pair giữ nguyên kết quả Layer 1/D relation.",
    ...
    "Tất cả slot H3/H7/H9/H12/H14/H16 hoạt động từ Thứ Hai đến Thứ Sáu; ngày đặc biệt chỉ làm đầu vào cho Final Reverse H3/H14/H16.",
  ...
  "EN": [
    ...
    "Layer 4 (Final Reverse) runs after pair derivation and is applied exactly once to XAUUSD only; GBP pair directions remain their Layer 1/D-relation outputs.",
    ...
    "All H3/H7/H9/H12/H14/H16 slots run Monday through Friday; special dates only feed the H3/H14/H16 Final Reverse rules.",
...
export const STARTUP_SUMMARY_BY_LOCALE = "v87: Persistent MT4 feed store + MT4 broker clock time authority + separated heartbeat + due slot catch-up";
