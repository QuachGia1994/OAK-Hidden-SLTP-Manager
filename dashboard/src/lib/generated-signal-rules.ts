...
export const ACTIVE_SIGNAL_LOGIC_VERSION = 63;
export const PUBLIC_SIGNAL_SLOTS = [3, 7, 9, 12, 14, 16] as const;
export const INTERNAL_SIGNAL_SLOTS = [4] as const;
...
export const RULES_BY_LOCALE = {
  "VN": [
    ...
    "H4 là slot nội bộ. H3 Thứ Năm không actionable. Thiếu dữ liệu hoặc DOJI không resolve được thì WAIT."
  ],
  "EN": [
    ...
    "H4 is an internal slot. Thursday H3 is non-actionable. Missing data or unresolved DOJI results in WAIT."
  ]
} as const;
...
export const STARTUP_SUMMARY_BY_LOCALE = {
  ...
  "EN": [
    ...
    "Safety: H4 internal · missing data → WAIT",
    "Auto-close: XAU 17:59 · GBP 19:59 Broker"
  ]
} as const;
