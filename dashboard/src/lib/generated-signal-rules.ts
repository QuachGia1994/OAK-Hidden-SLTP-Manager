...
export const ACTIVE_SIGNAL_LOGIC_VERSION = 83;
...
export const RULES_BY_LOCALE = {
  "VN": [
    ...
    "Signal Engine: D-Direction (nến H4 mở lúc 20:00 phiên Broker trước) + Day Mode động.",
    ...
    "Final Inversion — chỉ 3 rule: (A) H3 Thứ 4 nguồn D đảo; (B) H3 Thứ 5 nguồn D đảo; (C) H16 Thứ 6 nguồn D đảo.",
    "XAUUSD dùng chung D-Direction từ nguồn GBPUSD H4 20:00.",
    "Nếu phiên trước không có H4 mở lúc 20:00 → D = WAIT (MISSING_H4_20), retry cho đến khi có.",
  ...
  "EN": [
    ...
    "Signal Engine: D-Direction (H4 candle opened at 20:00 of previous broker session) + dynamic Day Mode.",
    ...
    "Final Inversion — only 3 rules: (A) Wed H3 D-sourced invert; (B) Thu H3 D-sourced invert; (C) Fri H16 D-sourced invert.",
    "XAUUSD shares D-Direction from GBPUSD H4 20:00 source.",
    "If previous session lacks H4 at 20:00 → D = WAIT (MISSING_H4_20), retry until found.",
...
export const STARTUP_SUMMARY_BY_LOCALE = "v83: H4 20:00 D recovery + 3 correct final inversions + auto-close removed" as const;
