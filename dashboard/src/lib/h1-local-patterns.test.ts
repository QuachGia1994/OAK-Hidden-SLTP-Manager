...
test("v99 H1 scanner exposes four active blocks, one XAU entry target and GBPUSD/GBPAUD market sources", () => {
  assert.deepEqual(H1_LOCAL_SCAN_HOURS, [3, 6, 9, 12]);
...
test("rule v99 has no legacy XAU weekday inversion badges", () => {
