...
export const SCHEDULE: { hour: number; note: string }[] = [
  ...
  { hour: 9, note: "T5: GBPAUD/GBPCAD/GBPUSD ngược, GBPJPY cùng | T6: Nhóm GBP cùng Vàng" },
  ...
  { hour: 16, note: "T5-6: Nhóm GBP + Vàng cùng (18:59)" },
];
