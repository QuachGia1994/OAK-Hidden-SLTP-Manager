...
export const SCHEDULE: { hour: number; note: string }[] = [
  ...
  { hour: 6, note: "T2,T6: Chỉ Vàng (đảo) | T3-5: Vàng đảo, GBPAUD ngược Vàng" },
...
export const DAY_RULES: Record<number, string[]> = {
  ...
  2: [    // Thứ 3 (JS: getDay() = 2)
    ...
    "H=2,3: GBPAUD, GBPJPY ngược. H=4: GBPAUD ngược. H=6: Vàng đảo, GBPAUD ngược Vàng",
