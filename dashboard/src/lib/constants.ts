...
export const SCHEDULE: { hour: number; note: string }[] = [
  ...
  { hour: 8, note: "T2: Nhóm GBP ngược | T3-6: GBPUSD, GBPCAD, GBPJPY (Vàng --)" },
...
export const HOUR_NOTES: Record<number, string> = {
  ...
  5: "T2: Nhóm GBP ngược | T3-6: GBPUSD, GBPCAD, GBPJPY ngược",
  6: "T2: Nhóm GBP ngược | T3-6: GBPUSD, GBPCAD, GBPJPY ngược",
  7: "T2: Nhóm GBP ngược | T3-6: GBPUSD, GBPCAD, GBPJPY ngược",
  8: "T2: Nhóm GBP ngược | T3-6: GBPUSD, GBPCAD, GBPJPY (Vàng --)",
