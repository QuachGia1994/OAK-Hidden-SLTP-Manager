...
export const SCHEDULE: { hour: number; note: string }[] = [
  ...
  { hour: 9, note: "T2-4,6: Nhóm GBP cùng (đảo) | T5: GBPAUD/GBPCAD/GBPUSD ngược, GBPJPY cùng (đảo)" },
  { hour: 11, note: "T2-T6: Nhóm GBP cùng Vàng (đảo)" },
...
export const HOUR_NOTES: Record<number, string> = {
  ...
  9: "T2-4,6: Nhóm GBP cùng (đảo) | T5: GBPAUD/GBPCAD/GBPUSD ngược, GBPJPY cùng (đảo)",
  11: "T2-T6: Nhóm GBP cùng Vàng (đảo)",
