...
export const SCHEDULE: { hour: number; note: string }[] = [
  ...
  { hour: 14, note: "T2: Nhóm GBP ngược | T3-6: Chỉ Vàng (GBP --)" },
...
export const HOUR_NOTES: Record<number, string> = {
  ...
  14: "T2: Nhóm GBP ngược | T3-6: Chỉ Vàng (GBP --)",
  15: "T2: Nhóm GBP ngược | T3-6: GBPUSD, GBPJPY cùng Vàng",
  16: "T2: Nhóm GBP ngược | T3-6: Nhóm GBP cùng Vàng",
};
