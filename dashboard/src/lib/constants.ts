...
export const SCHEDULE: { hour: number; note: string }[] = [
  ...
  { hour: 9, note: "T2-4: Nhóm GBP cùng Vàng | T5-6: Chỉ Vàng" },
  { hour: 10, note: "T2-4: Chỉ Vàng | T5-6: Chỉ Vàng" },
  { hour: 11, note: "T2-4: Nhóm GBP cùng Vàng | T5-6: Chỉ Vàng" },
  { hour: 12, note: "T2-4: Chỉ Vàng | T5-6: Chỉ Vàng" },
  { hour: 13, note: "T2-4: Chỉ Vàng | T5-6: Chỉ Vàng" },
