...
export function FactCheckMediaPublicView({ result }: { result: ImageAuthenticityResult }) {
  ...
  const t = locale === "VN"
    ? {
        eyebrow: "XÁC THỰC ẢNH", provenance: "Provenance", detectors: "Detector chuyên biệt", visual: "Phân tích hình ảnh",
    ...
    : {
        eyebrow: "IMAGE AUTHENTICITY", provenance: "Provenance", detectors: "Specialist detectors", visual: "Visual analysis",
