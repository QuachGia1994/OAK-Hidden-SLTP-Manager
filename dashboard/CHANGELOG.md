...
- Advanced local H1 to v73. H16 keeps normal entry-time calculation and BUY/SELL rendering on XAU H5 manual-close days; CLOSE remains an advisory badge only and no longer suppresses or replaces the H16 signal on Web, native iOS/Android or copied H1 PNGs. A fresh v73 state key clears stale CLOSE-only H16 rows.
