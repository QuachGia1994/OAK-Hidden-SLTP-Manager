...
def get_day_notes(now, lang="VN"):
    ...
    day_rules_vn = {
        0: ["Slots: H=2,4-6,9,11-15 (Gồm H=15:00)", "H=2: XAUUSD đảo từ H=5 hôm qua; GBPAUD cùng chiều H=5 hôm qua.", "H=6,8: XAUUSD đảo từ H=5 hôm nay.", "H=9: GBP đảo từ H=5 hôm qua.", "H=11: Phân nhóm H1 XAUUSD (SW/BT) từ H=10,9,8,7.", "H=12,13: XAUUSD đảo ngược H=4.", "H=14: GBP cùng chiều H=5 hôm nay.", "H=15:00: XAUUSD theo 4 nến M30 (13:00-14:30)."],
        1: ["Slots: H=2,4-6,9,11-15", "H=2: XAUUSD đảo từ H=5 hôm qua; GBPAUD cùng chiều H=5 hôm qua.", "H=6,8: XAUUSD đảo từ H=5 hôm nay.", "H=9: GBP đảo từ H=5 hôm qua.", "H=11: Phân nhóm H1 XAUUSD (SW/BT) từ H=10,9,8,7.", "H=12,13: XAUUSD đảo ngược H=4.", "H=14: GBP cùng chiều H=5 hôm nay."],
        2: ["Slots: H=2,4-6,9,11-15", "H=2: XAUUSD đảo từ H=5 hôm qua.", "H=6,8: XAUUSD đảo từ H=5 hôm nay.", "H=9: XAUUSD đảo từ H=5 hôm nay.", "H=11: Phân nhóm H1 XAUUSD (SW/BT) từ H=10,9,8,7.", "H=12,13: XAUUSD đảo ngược H=4.", "H=14: Tắt nhóm GBP (Thứ 4)."],
        3: ["Slots: H=2,4-6,9,11-15 (Gồm H=15:00)", "H=2: XAUUSD & GBPAUD dùng lại lịch sử của Thứ 2.", "H=6,8: XAUUSD đảo từ H=5 hôm nay.", "H=9: GBP đảo từ H=5 hôm qua.", "H=11: Phân nhóm H1 XAUUSD (SW/BT) từ H=10,9,8,7.", "H=12,13: XAUUSD đảo ngược H=4.", "H=14: GBP cùng chiều H=5 hôm nay.", "H=15:00: XAUUSD theo 4 nến M30 (13:00-14:30)."],
        4: ["Slots: H=2,4-6,9,11-15 (Gồm H=15:00)", "H=2: XAUUSD đảo từ H=5 hôm qua; GBPAUD ngược chiều H=5 hôm qua.", "H=6,8: XAUUSD đảo từ H=5 hôm nay.", "H=9: GBP cùng chiều H=5 hôm qua (Thứ 6).", "H=11: Phân nhóm H1 XAUUSD (SW/BT) từ H=10,9,8,7.", "H=12,13: XAUUSD đảo ngược H=4.", "H=14: GBP đảo từ H=5 hôm nay (Thứ 6).", "H=15:00: XAUUSD theo 4 nến M30 (13:00-14:30)."],
    }
    day_rules_en = {
        0: ["Slots: H=2,4-6,9,11-15 (Includes H=15:00)", "H=2: XAUUSD reverses from H=5 yesterday; GBPAUD follows H=5 yesterday.", "H=6,8: XAUUSD reverses from H=5 today.", "H=9: GBP reverses from H=5 yesterday.", "H=11: Classify H1 XAUUSD group (SW/BT) from H=10,9,8,7.", "H=12,13: XAUUSD reverses H=4.", "H=14: GBP follows H=5 today.", "H=15:00: XAUUSD based on 4 M30 candles (13:00-14:30)."],
        1: ["Slots: H=2,4-6,9,11-15", "H=2: XAUUSD reverses from H=5 yesterday; GBPAUD follows H=5 yesterday.", "H=6,8: XAUUSD reverses from H=5 today.", "H=9: GBP reverses from H=5 yesterday.", "H=11: Classify H1 XAUUSD group (SW/BT) from H=10,9,8,7.", "H=12,13: XAUUSD reverses H=4.", "H=14: GBP follows H=5 today."],
        2: ["Slots: H=2,4-6,9,11-15", "H=2: XAUUSD reverses from H=5 yesterday.", "H=6,8: XAUUSD reverses from H=5 today.", "H=9: XAUUSD reverses from H=5 today.", "H=11: Classify H1 XAUUSD group (SW/BT) from H=10,9,8,7.", "H=12,13: XAUUSD reverses H=4.", "H=14: GBP group disabled (Wed)."],
        3: ["Slots: H=2,4-6,9,11-15 (Includes H=15:00)", "H=2: XAUUSD and GBPAUD reuse Monday's history.", "H=6,8: XAUUSD reverses from H=5 today.", "H=9: GBP reverses from H=5 yesterday.", "H=11: Classify H1 XAUUSD group (SW/BT) from H=10,9,8,7.", "H=12,13: XAUUSD reverses H=4.", "H=14: GBP follows H=5 today.", "H=15:00: XAUUSD based on 4 M30 candles (13:00-14:30)."],
        4: ["Slots: H=2,4-6,9,11-15 (Includes H=15:00)", "H=2: XAUUSD reverses from H=5 yesterday; GBPAUD reverses H=5 yesterday (Fri).", "H=6,8: XAUUSD reverses from H=5 today.", "H=9: GBP follows H=5 yesterday (Fri).", "H=11: Classify H1 XAUUSD group (SW/BT) from H=10,9,8,7.", "H=12,13: XAUUSD reverses H=4.", "H=14: GBP reverses from H=5 today (Fri).", "H=15:00: XAUUSD based on 4 M30 candles (13:00-14:30)."],
    }
