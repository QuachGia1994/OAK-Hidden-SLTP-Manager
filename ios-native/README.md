...
- H16 is retired in rule v81 and is not rendered, exported or available for evidence. Actual broker-order execution remains independent from the H1 display matrix.
