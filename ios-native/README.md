...
- Rule v87 keeps XAUUSD as the shared entry-time pattern source. XAUUSD/GBPAUD/GBPCAD/GBPJPY derive BUY/SELL from previous available broker-day GBPUSD/AUDUSD/USDCAD/USDJPY H(entry-1) respectively, while GBPUSD keeps same-day own H(entry-1). H16 remains entry/evidence only; broker execution is independent.
