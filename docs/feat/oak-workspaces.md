...
- /engine: latest retained broker-day matrix for H3/H6/H9/H12/H14, single compact board header, FREE ACCESS and 20s refresh. Click a cell to open inline evidence with original base, final source, chronological OHLC chart and expandable bar details. H16 is retired in rule v79.
