...
class DashboardSignalSelectionTests(unittest.TestCase):
    ...
    def test_drops_removed_h5_records_even_when_pair_dirs_exist(self):
        signals = [
            {"date": "2026-07-03", "hour": 4, "signal": "BUY", "pair_dirs": {"XAUUSD": "BUY"}, "logic_version": 53},
            {"date": "2026-07-04", "hour": 4, "signal": "BUY", "pair_dirs": {"XAUUSD": "BUY"}, "logic_version": 53},
    ...
    def test_drops_current_records_without_a_valid_xauusd_direction(self):
        records = [
            {"date": "2026-07-03", "hour": 9, "logic_version": 53,
             "pair_dirs": {"GBPUSD": "BUY"}},
            {"date": "2026-07-03", "hour": 12, "logic_version": 53,
             "pair_dirs": {"XAUUSD": "WAIT"}},
            {"date": "2026-07-03", "hour": 9, "logic_version": 53,
             "signal": "SELL", "pair_dirs": {"XAUUSD": "BUY"}},
            {"date": "2026-07-03", "hour": 14, "logic_version": 53,
